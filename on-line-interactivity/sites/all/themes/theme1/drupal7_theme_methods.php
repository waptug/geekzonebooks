...
$art_style = '';
$art_head = '';
function theme1_process_html(&$variables) {
...
*/
function theme1_form_alter(&$form, &$form_state, $form_id) {
...
function theme1_form_element_label($variables) {
...
function theme1_form_element($variables) {
  $element = &$variables['element'];
  // This is also used in the installer, pre-database setup.
  $t = get_t();
...
function theme1_pager($variables) {
  $tags = $variables['tags'];
  $element = $variables['element'];
